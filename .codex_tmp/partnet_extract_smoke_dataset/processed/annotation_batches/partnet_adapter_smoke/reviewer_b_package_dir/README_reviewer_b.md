# MultiEEAffordance annotation package: reviewer_b

This package contains only the samples assigned to `reviewer_b` and the files
...
python MultiEEAffordance/tools/serve_v2_annotation_app.py \
  ...
  --samples processed/annotation_batches/partnet_adapter_smoke/reviewer_b_samples.jsonl \
  --review-jsonl processed/annotation_batches/partnet_adapter_smoke/reviewer_b_review_records.jsonl \
  --output-mask-root processed/annotation_batches/partnet_adapter_smoke/manual_refined_masks_reviewer_b \
  --output-samples processed/annotation_batches/partnet_adapter_smoke/reviewer_b_refined_samples.jsonl \
  --port 8765 \
  --top-k-candidates 12
```
